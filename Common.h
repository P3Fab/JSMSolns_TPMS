...
int ManchesterDecode_ZeroBit(int StartIndex)
{
   int i;
   bool bit1, bit2;
   byte b = 0;
...
int GetDisplayIndexFromID(unsigned long ID)
{
...
int GetDisplayIndexFromTyreIndex(int i)
{
...
bool ReceiveMessage()
{
  ...
  delayMicroseconds(2500);  //there is a delay on the serial data stream so ensure we allow a bit of extra time after CD finishes to ensure all the data is captured
